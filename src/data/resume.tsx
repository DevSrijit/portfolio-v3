...
export const DATA = {
  ...
  projects: [
    ...
    {
      title: "CO2 Bunny",
      href: "https://co2bunny.srijit.co",
      dates: "January 2025 - February 2025",
      active: true,
      description:
        "Created a RESTful API & Next.js Website to track the CO2 emissions of any website. Built with Express.js, MongoDB, Prisma and Next.js.",
      technologies: [
        "Next.js",
        "Prisma",
        "MongoDB",
      ...
      links: [
        ...
        {
          type: "Source",
          href: "https://github.com/devsrijit/co2-bunny",
